...
public class DropActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pickupLocation = findViewById(R.id.editTextDropLocation);
        ...
        Intent i = getIntent();
        String pickLoc = i.getStringExtra("pickLoc");



        next = findViewById(R.id.dropnext);
        ImageView pickupSearch = findViewById(R.id.dropSearch);

        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(pickupLocation.getText().toString().isEmpty()){
                    Toast.makeText(DropActivity.this, "Enter the Location", Toast.LENGTH_SHORT).show();
                }else{
                    String dropLoc = pickupLocation.getText().toString();
                    Intent i = new Intent(DropActivity.this,BetweenRouteActivity.class);
        ...
        transaction.add(R.id.startdropmaps, mapFragment);
        transaction.commit();

        getlocation = findViewById(R.id.getdropLocation);
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap gMap) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(DropActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION},REQUEST_LOCATION_PERMISSION);

                }

                // You can set up any initial map settings here
            }
        });
        ...
        pickupSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LatLng latLng = getLatLngFromLocation(DropActivity.this, location);
